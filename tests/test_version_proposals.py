...
from scripts.validate_proposed_package_version import check_proposed_version_is_allowed
...
class TestVersionProposal(TestCase):
    ...
    def test_old_major_is_not_allowed(self):
        self.assertRaises(Exception, lambda: check_proposed_version_is_allowed("1.18.0", "0.18.0"))

    def test_old_minor_is_not_allowed(self):
        self.assertRaises(Exception, lambda: check_proposed_version_is_allowed("0.18.0", "0.17.0"))

    def test_old_bump_is_not_allowed(self):
        self.assertRaises(Exception, lambda: check_proposed_version_is_allowed("0.18.1", "0.18.0"))
