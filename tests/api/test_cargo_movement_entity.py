...
class TestCargoMovementEntity(TestCase):
    ...
    def test_convert_to_flat_dict(self):
        ...
        expected = {'cargo_movement_id': '00886b05a0747522b67322f50123ee60e61e219fc9a9c6011be1a1dade65f63e',
                    ...
                    'product.group.label': 'Clean products', 'product.group.layer': 'group',
                    'product.group.probability': 0.4756425, 'product.group.source': 'model',
                    'product.group_product.id': 'a75fcc09bfc7d16496de3336551bc52b5891838bb7c22356d2cb65451587d1e5',
                    'product.group_product.label': 'Biodiesel', 'product.group_product.layer': 'group_product',
                    'product.group_product.probability': 0.4756425, 'product.group_product.source': 'model',
                    'product.grade.id': '9d52ede1cff0421a8cd7283b0171afe8d23f519dca5f4e489734522f9cdf804c',
                    'product.grade.label': 'Biodiesel Feedstock', 'product.grade.layer': 'grade',
                    'product.grade.probability': 0.4756425, 'product.grade.source': 'model', 'quantity': 4401,
                    'status': 'unloaded_state',
                    ...
                    'vessels.0.dwt': 5260, 'vessels.0.end_timestamp': '2019-10-25T00:40:46+0000',
                    'vessels.0.fixture_fulfilled': False, 'vessels.0.fixture_id': None,
                    'vessels.0.id': '9cbf7c0fc6ccf1dfeacde02b87f3b6b1653030f560d4fc677bf1d7d0be8f8449',
                    'vessels.0.imo': 9480980,
                    'vessels.0.mmsi': 255804460, 'vessels.0.name': 'JOHANN ESSBERGER',
