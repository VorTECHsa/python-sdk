...
class TestVesselMovement(TestCase):
    ...
    def test_flatten(self):
        ...
        expected = {
            ...
            "vessel.corporate_entities.0.label": "VITOL",
            "vessel.corporate_entities.0.layer": "charterer",
            "vessel.corporate_entities.0.probability": 1.0,
            "vessel.corporate_entities.0.source": "external",
            ...
            "vessel.corporate_entities.1.probability": 1.0,
            "vessel.corporate_entities.1.source": "external",
            ...
            "vessels.corporate_entities.commercial_owner.source": "external",
            "vessels.cubic_capacity": 172092,
            "vessels.dwt": 160391,
            "vessels.end_timestamp": None,
            "vessels.fixture_fulfilled": None,
            "vessels.fixture_id": None,
            "vessels.id": "6d8a8f0863ca087204dd68e5fc3b6469a879829e6262856e34856aea3ca20509",
            "vessels.imo": 9380893,
            "vessels.mmsi": 248896000,
            "vessels.name": "17 FEBRUARY",
            "vessels.start_timestamp": None,
            "vessels.status": "vessel_status_ballast",
            "vessels.vessel_class": "suezmax",
            "vessels.voyage_id": None,
        }
