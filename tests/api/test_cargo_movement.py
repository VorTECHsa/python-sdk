...
class TestCargoMovement(TestCase):
    ...
    def test_convert_to_flat_dict(self):
        ...
        expected = {
            ...
            "events.cargo_port_load_event.0.end_timestamp": datetime.datetime(
                2019, 10, 20, 16, 41, 49, tzinfo=datetime.timezone.utc
            ),
            ...
            "events.cargo_port_load_event.0.start_timestamp": datetime.datetime(
                2019, 10, 18, 21, 38, 34, tzinfo=datetime.timezone.utc
            ),
            ...
            "vessels.0.corporate_entities.commercial_owner.start_timestamp": None,
            "vessels.0.corporate_entities.commercial_owner.end_timestamp": None,
            "vessels.0.cubic_capacity": 6100,
            "vessels.0.dwt": 5260,
            "vessels.0.end_timestamp": datetime.datetime(
                2019, 10, 25, 00, 40, 46, tzinfo=datetime.timezone.utc
            ),
            ...
            "vessels.0.start_timestamp": datetime.datetime(
                2019, 10, 18, 21, 38, 34, tzinfo=datetime.timezone.utc
            ),
            ...
            "parent_ids.0.splinter_timestamp": datetime.datetime(
                2019, 10, 20, 16, 41, 49, tzinfo=datetime.timezone.utc
            ),
        }
