...
class TestCargoMovement(TestCase):
    ...
    def test_convert_to_flat_dict(self) -> None:
        ...
        expected = {
            ...
            "product.group.external_sources": None,
            ...
            "product.group_product.external_sources": None,
            ...
            "product.grade.probability": None,
            "product.grade.source": "external",
            "product.grade.external_sources.0.id": "9d52ede1cff0421a",
            "product.grade.external_sources.0.probability": 1.0,
