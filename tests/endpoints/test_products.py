...
class TestProducts(TestCaseUsingMockAPI):
    ...
    def test_serialize(self):
        crude_dict = {'id': '6f11b0724c9a4e85ffa7f1445bc768f054af755a090118dcf99f14745c261653',
                      'name': 'Crude',
                      'layer': ['group'],
                      'leaf': False,
                      'parent': [],
                      ...
                      'ref_type': 'product',
                      'hierarchy': [{'id': '6f11b0724c9a4e85ffa7f1445bc768f054af755a090118dcf99f14745c261653',
                                     'layer': 'group',
                                     'label': 'Crude'}]}
