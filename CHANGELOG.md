...
- Perf: Convert cargo movements to dataframe in parallel. [Christopher
  Burgess]
...
- Return all vessels from search, not just arbitrary 100 (#41) [Kit
  Burgess]
...
- Ci: Put flake config in setup.cfg so that pep8speaks can read it
  @cvonsteg. [Christopher Burgess]
...
- Add product_parent to product search params. Bug fix import statement.
  [dstarkey23]
- Why no Search feature in products.py? tests/products no longer works.
  [dstarkey23]
...
- Write test_products script in tests/endpoints (in progress)
  [dstarkey23]
...
0.2.0 (2019-11-18)
------------------
- Feat: Bump version to 0.2.0. [Christopher Burgess]
- Filter on name (#27) [Kit Burgess]

  Filter on name
- Update tests/test_id.py. [syed]
- Feat: Convert IDs to names. [Christopher Burgess]
- Merge remote-tracking branch 'origin/master' into filter-on-name.
  [Christopher Burgess]
...
- Refactor: Move private methods to appropriate module. [Christopher
  Burgess]
- Feat: Allow filtering cargo movements using entity name. [Christopher
  Burgess]
...
- Merge branch 'master' into live-ci-tests. [Kit Burgess]
- Feat: Allow user to search cargo movements with single filter, fi…
  (#21) [Kit Burgess]
...
- Feat: Allow user to search cargo movements with single filter, fixes
  #16. [Christopher Burgess]
...
- Refactor: Rename root dir from vortexa to vortexasdk (#12) [Kit
  Burgess]

  refactor: Rename root dir from vortexa to vortexasdk
- Chore: Use correct email address. [Christopher Burgess]
- Refactor: Rename root dir from vortexa to vortexasdk. [Christopher
  Burgess]
- Docs: Add tips to contributing docs. [Christopher Burgess]
- Refactor: Allow clients to import classes without knowledge of int…
  (#8) [Kit Burgess]
...
- Refactor: Allow clients to import classes without knowledge of
  internals. [Christopher Burgess]
...
- Merge remote-tracking branch 'origin/master' into vessels-cleanup.
  [Christopher Burgess]
...
- Test: Vessel dataframe test actually does something. [Christopher
  Burgess]
...
- Ci: Generate docs on any branch, only deploy on master. [Christopher
  Burgess]
- Test: Correctly annotate live cargo movement tests. [Christopher
  Burgess]
...
- Refactor: Reduce duplication when creating params. [Christopher
  Burgess]
- Feat: Add Node reference return objects. [Christopher Burgess]
- Feat: Filter cargo movement columns. [Christopher Burgess]
- Feat: Filter cargo movement columns. [Christopher Burgess]
...
- Refactor: Move endpoint callers into endpoints package. [Christopher
  Burgess]
- Docs: Document vessel endpoint. [Christopher Burgess]
- Feat: Serialize CargoMovementEntity. [Christopher Burgess]
- Create LICENSE. [Kit Burgess]
- Docs: Document Entities. [Christopher Burgess]
- Test: Add CargoEventEntity tests. [Christopher Burgess]
- Docs: Add vessels documentation with pandas example. [Christopher
  Burgess]
- Feat: Read vessels as dataframe. [Christopher Burgess]
- Chore: Add a second demo example. [Christopher Burgess]
- Feat: Autogenerate python docs examples. [Christopher Burgess]
- Refactor: Move tests to test package. [Christopher Burgess]
- Feat: Add paging. [Christopher Burgess]
- Feat: Call cargo movements api. [Christopher Burgess]
- Docs: Use keras inspired docs. [Christopher Burgess]
- Docs: Add documentation for Search and Reference classes. [Christopher
  Burgess]
- Style: Experiment using portray and pydocmd. [Christopher Burgess]
- Feat: We can now search on geographies. [Christopher Burgess]
- Feat: Complete the get reference. [Christopher Burgess]
- Chore: Re-enable flake. [Christopher Burgess]
- Feat: Add corporate entity. [Christopher Burgess]
- Feat: Add ProductLayer enum. [Christopher Burgess]
...
- Feat: Add maiden and final voyages. [Christopher Burgess]
- Feat: Compare US to asia average journey times. [Christopher Burgess]
- Feat: Sample notebook now finds number of clean -> dirty swaps by day.
  [Christopher Burgess]
- Feat: Add initial sample notebook. [Christopher Burgess]
