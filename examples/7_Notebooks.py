...
# -*- coding: utf-8 -*-
"""
Created on Wed May 27 18:58:44 2020
...
Those notebooks include:
   ...
   2. [China Oil Flows during the Covid-19 Outbreak](https://github.com/VorTECHsa/python-sdk/blob/master/docs/examples/China_Flows.ipynb)
   3. [Crude Floating Storage and its relation to Prices](https://github.com/VorTECHsa/python-sdk/blob/master/docs/examples/Crude_Floating_Storage.ipynb)
