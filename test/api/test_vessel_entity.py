...
ce2 = CorporateEntity(id='0bdf9acdc00ad52d9b8c44dad815087a89205a9c83f53ed89e029f7d15b9ac14',
                      layer="charterer", probability=1, label='CHEVRON', source='external')
ve = VesselEntity(
...
class TestVesselEntity(TestCase):
    ...
    def test_serialize(self):
        with open("test/api/examples/vessel_entity1.json", 'r') as f:
            serialized = f.read()
