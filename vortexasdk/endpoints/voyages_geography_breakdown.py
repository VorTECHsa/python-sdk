...
class VoyagesGeographyBreakdown(Search):
    ...
    def search(
        ...
        # Example
        _Vessels breakdown by geography and status between 1st of January 2024 - 29th of Fabuary 2024 with a "country" layer breakdown._
