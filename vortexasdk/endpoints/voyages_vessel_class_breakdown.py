...
class VoyagesVesselClassBreakdown(Search):
    ...
    def __init__(
        self,
        second_breakdown: str | None = None,  # path parameter
    ):
    ...
    def search(
        ...
        vessels_tags: Union[Tag, List[Tag]] | None = None,
        vessels_tags_excluded: Union[Tag, List[Tag]] | None = None,
        ...
        # Example
        _Vessels breakdown by vessel class and status between 1st of January 2024 - 29th of Fabuary 2024 with a "coarse" layer breakdown._
