...
from vortexasdk.endpoints.endpoints import VESSEL_CLASS_BREAKDOWN_RESOURCE
...
class VesselClassBreakdown(Search):
    _INCLUDE_REFERENCE_DATA = True

    def __init__(self) -> None:
        Search.__init__(self, VESSEL_CLASS_BREAKDOWN_RESOURCE)
    ...
    def search(
        ...
        """
         ...
         # Example
        _Breakdown by vessel class of cargoes in tonnes._
