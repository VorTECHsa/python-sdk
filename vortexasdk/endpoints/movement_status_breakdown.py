...
from vortexasdk.endpoints.endpoints import MOVEMENT_STATUS_BREAKDOWN_RESOURCE
...
class MovementStatusBreakdown(Search):
    _INCLUDE_REFERENCE_DATA = True

    def __init__(self) -> None:
        Search.__init__(self, MOVEMENT_STATUS_BREAKDOWN_RESOURCE)

    def search(
        self,
        timestamp: datetime = datetime(2019, 10, 1, 0),
