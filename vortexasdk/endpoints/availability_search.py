...
from vortexasdk.endpoints.availability_result import AvailabilityResult

from vortexasdk.api import ID
from vortexasdk.endpoints.endpoints import AVAILABILITY_SEARCH_RESOURCE
...
class AvailabilitySearch(Search):
    ...
    def __init__(self):
        Search.__init__(self, AVAILABILITY_SEARCH_RESOURCE)
    ...
    def search(
        ...
        return AvailabilityResult(super().search(**api_params))
