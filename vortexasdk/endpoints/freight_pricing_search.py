...
class FreightPricingSearch(Search):
    ...
    def __get_ISO_Dates(days: Union[List, None] ) -> List:
    ...
    def search(
        ...
        # Arguments
            ...
            days: Used to filter results by day on which the record was generated. Must be an ISO date or an empty array.
        ...
        return FreightPricingResult(super().search(**api_params))
