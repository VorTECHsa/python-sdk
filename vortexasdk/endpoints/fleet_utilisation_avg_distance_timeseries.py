...
class FleetUtilisationAvgDistanceTimeseries(Search):
    ...
    def search(
        ...
        are calculated by summing each daily average distance bucket and returning the total.
        ...
        # Arguments
            ...
            exclude_filter_controllers: An effective controller ID, or list of effective controller IDs to exclude.
