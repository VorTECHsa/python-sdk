...
class VesselPositions(Search):
    ...
    def search(
        self,
        vessel_id: Optional[Union[str, List[str]]] = None,
        vessel_class: Optional[Union[str, List[str]]] = None,
        time_max: Optional[ISODate] = None,
        time_min: Optional[ISODate] = None,
        interval: str = "1d",
        ...
        return VesselPositionsResult(records=response["data"])
