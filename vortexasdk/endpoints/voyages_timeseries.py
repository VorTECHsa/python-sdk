...
class VoyagesTimeseries(Search):
    ...
    def search(
        ...
        Returns a sum or average timeseries aggregation of voyages.
        ...
        |---:|:--------------------------|--------:|--------:|:--------------------|--------------------:|--------------------:|
        |  0 | 2022-04-26 00:00:00+00:00 |     204 |     204 | Netherlands         |                  87 |                  87 |
        |  1 | 2022-04-27 00:00:00+00:00 |      38 |      38 | Netherlands         |                  15 |                  15 |
        |  2 | 2022-04-28 00:00:00+00:00 |       5 |       5 | Netherlands         |                   2 |                   2 |
        ```
        """
        api_params = {
