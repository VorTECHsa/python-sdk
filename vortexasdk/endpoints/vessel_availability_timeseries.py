...
class VesselAvailabilityTimeseries(Search):
    ...
    def search(
        ...
        filter_vessel_status: str | None = None,
        filter_vessel_location: Union[ID, List[ID]] | None = None,
        filter_owners: Union[ID, List[ID]] | None = None,
        filter_effective_controllers: Union[ID, List[ID]] | None = None,
        filter_destination: Union[ID, List[ID]] | None = None,
        filter_region: str | None = None,
        filter_port: str | None = None,
        use_reference_port: bool = False,
        filter_days_to_arrival: List[Dict[str, int]] | None = None,
        filter_vessel_dwt_min: int | None = None,
        filter_vessel_dwt_max: int | None = None,
        filter_vessel_age_min: int | None = None,
        filter_vessel_age_max: int | None = None,
        filter_vessel_idle_min: int | None = None,
        filter_vessel_idle_max: int | None = None,
        filter_vessel_scrubbers: str = "disabled",
        filter_recent_visits: str | None = None,
        filter_vessel_flags: Union[ID, List[ID]] | None = None,
        filter_vessel_ice_class: Union[ID, List[ID]] | None = None,
        filter_vessel_tags: Union[List[Tag], Tag] | None = None,
        filter_vessel_risk_level: Union[str, List[str]] | None = None,
        ...
        exclude_vessel_status: str | None = None,
        exclude_vessel_location: Union[ID, List[ID]] | None = None,
        exclude_owners: Union[ID, List[ID]] | None = None,
        exclude_effective_controllers: Union[ID, List[ID]] | None = None,
        exclude_destination: Union[ID, List[ID]] | None = None,
        exclude_filter_vessel_flags: Union[ID, List[ID]] | None = None,
        exclude_filter_vessel_ice_class: Union[ID, List[ID]] | None = None,
        exclude_filter_vessel_tags: Union[List[Tag], Tag] | None = None,
        exclude_filter_vessel_risk_level: Union[str, List[str]] | None = None,
    ) -> TimeSeriesResult:
        """
