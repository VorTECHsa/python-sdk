...
class CargoMovements(Search):
    ...
    def search(
        self,
        filter_activity: str,
        filter_time_min: datetime = datetime.today() - timedelta(days=1),
        filter_time_max: datetime = datetime.today(),
        cm_unit: str = "b",
        ...
        # Arguments
            ...
            filter_time_min: The UTC start date of the time filter. Defaults to yesterday.

            filter_time_max: The UTC end date of the time filter. Defaults to today.
