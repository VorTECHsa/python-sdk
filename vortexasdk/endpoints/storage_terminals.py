...
class StorageTerminals(Reference, Search):
    ...
    def __init__(self) -> None:
        Reference.__init__(self, STORAGE_TERMINALS_REFERENCE)
        Search.__init__(self, STORAGE_TERMINALS_REFERENCE)
    ...
    def search(
        ...
        term: Union[str, List[str]] | None = None,
