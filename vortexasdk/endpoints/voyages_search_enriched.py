...
class VoyagesSearchEnriched(Search):
    ...
    def search(
        ...
        has_ship_to_ship: str | None = None,
        has_charterer: str | None = None,
        ...
        event_types_excluded: Union[str, List[str]] | None = None,
        congestion_target_location: Union[ID, List[ID]] | None = None,
        congestion_target_location_excluded: Union[ID, List[ID]] | None = None,
    ) -> Union[
