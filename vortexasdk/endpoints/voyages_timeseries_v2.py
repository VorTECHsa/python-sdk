...
class VoyagesTimeseriesV2(Search):
    ...
    def __init__(
        self,
        metric: str = None,  # path parameter
        breakdown_property: str = None,  # path parameter,
    ):
        Search.__init__(
    ...
    def search(
        ...
        ...    time_max=datetime(2024, 3, 31, 23, 59),
        ...
        ```
        |    | key                       |   value |   count | breakdown.0.label   |   breakdown.0.count |   breakdown.0.value | breakdown.1.label   |   breakdown.1.count |   breakdown.1.value | breakdown.2.label   |   breakdown.2.count |   breakdown.2.value |
        |---:|:--------------------------|--------:|--------:|:--------------------|--------------------:|--------------------:|:--------------------|--------------------:|--------------------:|:--------------------|--------------------:|--------------------:|
        |  0 | 2024-01-01T00:00:00.000Z  |   40995 |   40995 | laden               |               20834 |               20834 | ballast             |               20097 |               20097 | Undetermined        |                  64 |                  64 |
        |  0 | 2024-02-01T00:00:00.000Z  |   36483 |   36483 | laden               |               18551 |               18551 | ballast             |               17850 |               17850 | Undetermined        |                  82 |                  82 |
        |  0 | 2024-03-01T00:00:00.000Z  |    3122 |    3122 | laden               |                3122 |                3122 |                     |                     |                     |                     |                     |                     |
        ```
        """
