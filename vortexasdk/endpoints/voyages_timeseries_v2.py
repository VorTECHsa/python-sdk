...
class VoyagesTimeseriesV2(Search):
    ...
    # Arguments
        ...
        metric: Used to build the value of the aggregation. Can be one of: `'voyage-count'`, `'tonne-miles-sum'`, `'distance-avg'`, `'distance-voyage-avg'`.

        breakdown_property: Defines the voyage property to aggregate upon. Can be one of: `'status'`, `'vessel-class-group'`, `'vessel-class-coarse'`, `'vessel-class-granular'`, `'origin-region'`, `'origin-shipping-region'`, `'origin-wider-shipping-region'`, `'origin-trading-region'`, `'origin-basin'`, `'origin-alternative-region'`, `'origin-state-or-province'`, `'origin-trading-sub-region'`, `'origin-trading-block'`, `'origin-country'`, `'origin-port'`, `'origin-terminal'`, `'origin_port_or_sts_zone'`, `'destination-region'`, `'destination-shipping-region'`, `'destination-wider-shipping-region'`, `'destination-trading-basin'`, `'destination-alternative-region'`, `'destination-state-or-province'`, `'destination-trading-region'`, `'destination-trading-sub-region'`, `'destination-trading-block'`, `'destination-country'`, `'destination-port'`, `'destination-terminal'`, `'destination_port_or_sts_zone'`, `'location-waypoint'`, `'product-group'`, `'product-group-product'`, `'product-category'`, `'product-grade'`, `'corporate-entity-cargo-trader'`, `'corporate-entity-charterer'`, `'corporate-entity-effective-controller'`, `'corporate-entity-vessel-owner'`, `'corporate-entity-time-charterer'`.
    """

    def __init__(
        self,
        metric: str,  # metric parameter
        breakdown_property: Optional[str] = None,  # breakdown parameter,
    ):
        if breakdown_property is None:
            url = f"{VOYAGES_TIMESERIES}/{metric}"
        else:
            url = f"{VOYAGES_TIMESERIES}/{metric}/{breakdown_property}"
        Search.__init__(self, url)
    ...
    def search(
        ...
        voyage_id: Union[ID, List[ID]] | None = None,
        cargo_movement_id: Union[ID, List[ID]] | None = None,
        voyage_status: Union[str, List[str]] | None = None,
        voyage_status_excluded: Union[str, List[str]] | None = None,
        movement_status: Union[str, List[str]] | None = None,
        movement_status_excluded: Union[str, List[str]] | None = None,
        cargo_status: Union[str, List[str]] | None = None,
        cargo_status_excluded: Union[str, List[str]] | None = None,
        location_status: Union[str, List[str]] | None = None,
        location_status_excluded: Union[str, List[str]] | None = None,
        commitment_status: Union[str, List[str]] | None = None,
        commitment_status_excluded: Union[str, List[str]] | None = None,
        exclude_overlapping_entries: bool | None = None,
        products: Union[ID, List[ID]] | None = None,
        products_excluded: Union[ID, List[ID]] | None = None,
        latest_products: Union[ID, List[ID]] | None = None,
        latest_products_excluded: Union[ID, List[ID]] | None = None,
        charterers: Union[ID, List[ID]] | None = None,
        charterers_excluded: Union[ID, List[ID]] | None = None,
        effective_controllers: Union[ID, List[ID]] | None = None,
        effective_controllers_excluded: Union[ID, List[ID]] | None = None,
        origins: Union[ID, List[ID]] | None = None,
        origins_excluded: Union[ID, List[ID]] | None = None,
        destinations: Union[ID, List[ID]] | None = None,
        destinations_excluded: Union[ID, List[ID]] | None = None,
        voyage_origins: Union[ID, List[ID]] | None = None,
        voyage_origins_excluded: Union[ID, List[ID]] | None = None,
        voyage_destinations: Union[ID, List[ID]] | None = None,
        voyage_destinations_excluded: Union[ID, List[ID]] | None = None,
        locations: Union[ID, List[ID]] | None = None,
        locations_excluded: Union[ID, List[ID]] | None = None,
        congestion_target_location: Union[str, List[str]] | None = None,
        congestion_target_location_excluded: (
            Union[str, List[str]] | None
        ) = None,
        vessels: Union[ID, List[ID]] | None = None,
        vessels_excluded: Union[ID, List[ID]] | None = None,
        flags: Union[ID, List[ID]] | None = None,
        flags_excluded: Union[ID, List[ID]] | None = None,
        ice_class: Union[ID, List[ID]] | None = None,
        ice_class_excluded: Union[ID, List[ID]] | None = None,
        vessel_propulsion: Union[ID, List[ID]] | None = None,
        vessel_propulsion_excluded: Union[ID, List[ID]] | None = None,
        vessel_age_min: int | None = None,
        vessel_age_max: int | None = None,
        vessel_dwt_min: int | None = None,
        vessel_dwt_max: int | None = None,
        vessel_cbm_min: int | None = None,
        vessel_cbm_max: int | None = None,
        vessel_wait_time_min: int | None = None,
        vessel_wait_time_max: int | None = None,
        vessel_scrubbers: str | None = None,
        vessel_tags: Union[Tag, List[Tag]] | None = None,
        vessel_tags_excluded: Union[Tag, List[Tag]] | None = None,
        vessel_risk_level: Union[str, List[str]] | None = None,
        vessel_risk_level_excluded: Union[str, List[str]] | None = None,
        has_ship_to_ship: bool | None = None,
        has_charterer: bool | None = None,
        vessel_owners: Union[ID, List[ID]] | None = None,
        vessel_owners_excluded: Union[ID, List[ID]] | None = None,
        time_charterer: Union[ID, List[ID]] | None = None,
        time_charterer_excluded: Union[ID, List[ID]] | None = None,
