...
from vortexasdk.endpoints.endpoints import PARENT_PRODUCT_BREAKDOWN_RESOURCE
...
class ParentProductBreakdown(Search):
    ...
    def __init__(self) -> None:
        Search.__init__(self, PARENT_PRODUCT_BREAKDOWN_RESOURCE)
