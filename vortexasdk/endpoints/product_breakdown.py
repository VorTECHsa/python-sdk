...
from vortexasdk.endpoints.endpoints import PRODUCT_BREAKDOWN_RESOURCE
...
class ProductBreakdown(Search):
    _INCLUDE_REFERENCE_DATA = True

    def __init__(self) -> None:
        Search.__init__(self, PRODUCT_BREAKDOWN_RESOURCE)

    def search(
        self,
        breakdown_product: str = "group",
        breakdown_unit_average_basis: str | None = None,
        ...
        exclude_waypoints: Union[ID, List[ID]] | None = None,
        exclude_storage_locations: Union[ID, List[ID]] | None = None,
        exclude_ship_to_ship_locations: Union[ID, List[ID]] | None = None,
        exclude_vessel_ice_class: Union[ID, List[ID]] | None = None,
        exclude_vessel_propulsion: Union[ID, List[ID]] | None = None,
        exclude_vessel_tags: Union[List[Tag], Tag] | None = None,
        ...
        """
         ...
         # Arguments
             ...
             breakdown_product: This represents the different levels of the product hierarchy. With 'group' being the top level, and grade being the lowest - or most accurate.
        ...
        _Breakdown by product of the cargoes in tonnes._
         ...
         ```python
         >>> from vortexasdk import ProductBreakdown
         >>> start = datetime(2019, 11, 10)
         >>> end = datetime(2019, 11, 15)
         >>> df = ProductBreakdown().search(
         ...        filter_activity="loading_end",
         ...        breakdown_product="group",
         ...        breakdown_unit="t",
         ...        breakdown_size=5,
