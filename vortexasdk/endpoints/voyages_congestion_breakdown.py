...
from vortexasdk.endpoints.voyages_congestion_breakdown_result import CongestionBreakdownResult
...
class VoyagesCongestionBreakdown(Search):
    ...
    def search(
        ...
        return CongestionBreakdownResult(super().search(**api_params))
